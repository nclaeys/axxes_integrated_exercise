...
2. (bis): you can write a couple of unit tests that verify the output of your pyspark transformation function. To make it simple, you can define a test fixture that launches a local Spark cluster as follows:
```
import pytest
